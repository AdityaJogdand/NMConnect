...
public class CrHomePage extends AppCompatActivity {
    ...
    TextView studentName, sapid, rollno, branch, initials, tvMonthYear, tvNoAnnouncements, tvNoMarks, crBadge;
    View profile;
    ...
    private void initializeViews() {
        ...
        crBadge = findViewById(R.id.crBadge);
    ...
    protected void onResume() {
        super.onResume();
        // Refresh announcements when coming back from AddAnnouncementActivity
        SessionManager session = new SessionManager(this);
        String branchName = session.getBranch();
        String semester = session.getSemester();
        loadAnnouncementsWithCache(branchName, semester);
